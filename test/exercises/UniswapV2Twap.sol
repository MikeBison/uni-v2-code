...
contract UniswapV2Twap {
        ...
        returns (uint256 price0Cumulative, uint256 price1Cumulative)
    {
        ...
        if (blockTimestampLast != blockTimestamp) {
            ...
            uint32 dt = blockTimestampLast - updatedAt;
            ...
            unchecked {
                ...
                price1Cumulative += uint256(FixedPoint.fraction(reserve1, reserve0)._x) * dt;
            }
        }
    }
    ...
    function update() external {
        ...
        require(dt >= MIN_WAIT, "UniswapV2Twap update: time elapsed < MIN_WAIT");
    ...
    function consult(
        ...
        require(tokenIn == token0 || tokenIn == token1, "NOT_SUPPORTED");
